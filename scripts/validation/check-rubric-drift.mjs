...
const REFERENCE_RUBRIC = join(ROOT, '.claude/context/artifacts/reference/standard-plan-rubric.json');
  ...
  if (rootExists && referenceExists) {
    try {
      ...
      if (rootNormalized !== referenceNormalized) {
        errors.push('Rubric files have drifted - content differs between root and reference locations.');
