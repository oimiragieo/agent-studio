...
Projects Configuration Guide - Steps for setting up Claude Projects with preloaded knowledge, style, and guardrails for each workspace.
</protocol_description>
...
<examples>
<usage_example>
**Reference**: [2] Anthropic, "Projects" (Jun 2024).
</usage_example>
</examples>
