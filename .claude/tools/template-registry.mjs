...
export const AGENT_TEMPLATE_MAP = {
  ...
  analyst: [
    '.claude/templates/project-brief.md'
  ],
  pm: [
  ...
  'ux-expert': [
    '.claude/templates/ui-spec.md',
    '.claude/templates/project-constitution.md'
  ],
  architect: [
    '.claude/templates/architecture.md',
    '.claude/templates/project-constitution.md'
  ],
  developer: [
  ...
  'code-reviewer': [
    '.claude/templates/code-review-report.md'
  ],
  'technical-writer': [
    '.claude/templates/claude-md-template.md'
  ],
  ...
  'refactoring-specialist': [
    '.claude/templates/refactor-plan.md'
  ],
  'compliance-auditor': [
    '.claude/templates/compliance-report.md'
  ],
  devops: [
    '.claude/templates/infrastructure-config.md'
  ],
  'cloud-integrator': [
...
export function getAllTemplates(agentName) {
  return [
    ...getRequiredTemplates(agentName),
    ...getOptionalTemplates(agentName)
  ];
}
