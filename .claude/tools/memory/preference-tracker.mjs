...
export class PreferenceTracker {
    ...
    async recordPreference(sessionId, key, value, confidence = 1.0) {
        ...
        try {
            ...
            console.log(`[PreferenceTracker] Recorded preference for user ${userId}: ${key} = ${value} (confidence: ${confidence})`);
    ...
    async updateConfidence(userId, key, newConfidence) {
        ...
        try {
            ...
            console.log(`[PreferenceTracker] Updated confidence for ${userId}/${key}: ${oldConfidence} → ${newConfidence}`);
    ...
    async applyConfidenceDecay(userId, daysStale, decayFactor = 0.8) {
        ...
        try {
            ...
            console.log(`[PreferenceTracker] Applied confidence decay: ${decayedCount} preferences updated`);
