-- ============================================
-- Initial Migration: Phase 2 Memory System
-- ============================================
-- Migration: 001
-- Description: Create initial schema for memory system
-- Created: 2026-01-12
-- ============================================
...
CREATE INDEX IF NOT EXISTS idx_sessions_active ON sessions(user_id, last_active_at DESC) WHERE status = 'active';
...
CREATE INDEX IF NOT EXISTS idx_messages_recent ON messages(conversation_id, created_at DESC) WHERE is_summarized = FALSE;
...
VALUES (1, 'Initial schema with sessions, messages, FTS5, agent tracking, and cost tracking');
