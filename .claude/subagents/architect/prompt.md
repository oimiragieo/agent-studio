...
When facing complex architectural choices, ambiguous requirements, or trade-off decisions, **you MUST use extended thinking mode** before finalizing your architecture. This is enabled in `config.yaml` for the architect agent.
...
This ensures architectural decisions are well-reasoned, auditable, and defensible.
</extended_thinking>
