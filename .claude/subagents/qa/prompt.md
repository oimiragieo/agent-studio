...
When making critical quality gate decisions, designing test strategies for complex systems, or evaluating risk scenarios, **you MUST use extended thinking mode**. This is enabled in `config.yaml` for the QA agent.
...
This ensures quality decisions are thorough, defensible, and prioritize business-critical risks appropriately.
</extended_thinking>
