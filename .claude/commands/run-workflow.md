...
<command_description>
Command: /run-workflow - Validate the output of a workflow step against its defined schema/gate. This ensures that the artifact produced by an agent meets the requirements before proceeding.
</command_description>
