...
- Save artifacts to `.claude/context/runtime/runs/<run_id>/artifacts/`
...
- Skill reads file system artifacts:
  ...
  - Artifact registry: `.claude/context/runtime/runs/<run_id>/artifact-registry.json`
  - Gate files: `.claude/context/runtime/runs/<run_id>/gates/*.json`
...
1. Load plan document from `.claude/context/runtime/runs/<run_id>/plans/`
2. Load artifact registry from `.claude/context/runtime/runs/<run_id>/artifact-registry.json`
3. Load gate files from `.claude/context/runtime/runs/<run_id>/gates/`
4. Identify last completed step (latest gate file)
5. Load artifacts from `.claude/context/runtime/runs/<run_id>/artifacts/`
