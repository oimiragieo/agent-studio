...
## Success Criteria
- [ ] Tests generated (artifact: test-files.json)
...
- [ ] Coverage adequate (artifact: coverage-report.json, validated by gate file)
- [ ] Tests follow patterns (validated by rule-auditor)
- [ ] Edge cases covered (artifact: test-scenarios.json)
