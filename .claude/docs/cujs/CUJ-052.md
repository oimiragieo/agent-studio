...
- Migrate artifacts to new path: `.claude/context/runtime/runs/<run_id>/artifact-registry.json`
...
- New registry: `.claude/context/runtime/runs/<run_id>/artifact-registry.json`
...
| Migration completed           | New registry exists             | All artifacts in `.claude/context/runtime/runs/<run_id>/artifact-registry.json`           |
