...
## Success Criteria
- [ ] Conflicts detected when comparing agent outputs (artifact: conflict-detection.json)
...
- [ ] Conflict type and severity assessed correctly (artifact: conflict-detection.json)
- [ ] Conflicts escalated to appropriate resolution agent (artifact: resolution-log.json)
- [ ] Consensus built successfully (when needed) (artifact: consensus-decision.json)
- [ ] Resolutions applied to affected artifacts (artifact: updated-artifacts.json)
- [ ] All affected agents notified (artifact: notification-log.json)
- [ ] Plan updated to reflect resolution (artifact: plan-{id}.json)
- [ ] Resolution documented in reasoning file (artifact: reasoning-{step}.json)
- [ ] Workflow continues after resolution (validated by gate file)
