...
- [algolia-search Skill Documentation](.claude/skills/algolia-search/SKILL.md)
- [search-setup-flow Workflow](.claude/workflows/search-setup-flow.yaml)
- [Search Integration Guide](.claude/docs/SEARCH_INTEGRATION.md)
