...
- Reads checkpoint: `.claude/context/runtime/checkpoints/{{workflow_id}}/step-3-checkpoint.json`
...
- Checkpoint artifacts: `.claude/context/runtime/checkpoints/{{workflow_id}}/step-3-checkpoint.json`
