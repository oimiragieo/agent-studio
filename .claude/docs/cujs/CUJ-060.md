...
**Workflow File**: `.claude/workflows/ai-system.yaml`
...
- Factory Droid setup guide removed in this release (Factory integration not shipped).
...
- Platform state: `.claude/context/runtime/runs/{{run_id}}/platform-state.json`
