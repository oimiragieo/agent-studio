...
|-----------|-------------|--------|
| Missing artifacts detected | Detection report | Missing artifacts identified correctly |
...
| Recovery strategy determined | Strategy selection | Appropriate recovery approach chosen |
| Artifacts recreated | Recreation validation | Artifacts successfully recreated |
| Recreated artifacts validated | Gate validation | Recreated artifacts pass validation |
| Artifacts registered | Registry validation | Registered in artifact registry |
| Workflow continues | Workflow continuation | Seamless workflow continuation |
| Recovery validation passes | Validation report | Recovery validation successful |
| No duplicate work | Work log validation | No redundant work performed |
