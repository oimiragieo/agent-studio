...
- Registry persistence: `.claude/context/runtime/runs/<run_id>/artifact-registry.json`

## Expected Outputs

- Retry test plan: `plan-{{workflow_id}}.json`
- Test artifacts with various publishing scenarios
- Registry files with retry attempt tracking: `.claude/context/runtime/runs/<run_id>/artifact-registry.json`
