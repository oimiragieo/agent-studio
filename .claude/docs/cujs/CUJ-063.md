...
**Execution Mode**: `recovery-test-flow.yaml`
...
- Outputs: Checkpoint files in `.claude/context/runs/<run_id>/checkpoints/`
...
- Checkpoint files (`.claude/context/runs/<run_id>/checkpoints/checkpoint-phase-*.json`)
...
- [ ] Plan rating recorded: Rating file exists at `.claude/context/runs/<run_id>/plans/<plan_id>-rating.json`
- [ ] Checkpoint created after each major phase: Files exist at `.claude/context/runs/<run_id>/checkpoints/checkpoint-phase-{1,3,5}.json`
