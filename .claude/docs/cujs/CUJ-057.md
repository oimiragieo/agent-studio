...
- Rating artifact: `.claude/context/runtime/runs/{run_id}/plans/{plan_id}-rating.json`
...
| Rating recorded             | Rating file exists         | Recorded in `.claude/context/runtime/runs/{run_id}/plans/{plan_id}-rating.json` |
...
- [Plan Rating Enforcement](../PLAN_RATING_GUIDE.md)
