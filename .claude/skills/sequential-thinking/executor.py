"""
Executor for sequential-thinking Skill - Handles dynamic MCP tool calls.

This executor connects to the sequential-thinking MCP server and executes tool calls
...
class SequentialThinkingExecutor:
    """Executor for sequential-thinking MCP server tools."""
...
async def main():
    ...
    parser = argparse.ArgumentParser(description=f"Execute sequential-thinking MCP tools")
