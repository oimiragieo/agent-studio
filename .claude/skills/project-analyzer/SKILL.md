...
context:fork: true
model: sonnet
allowed-tools: read, glob, search, codebase_search, Bash
version: 1.0.0
executable: .claude/skills/project-analyzer/analyzer.mjs
test_suite: .claude/skills/project-analyzer/tests/analyzer.test.mjs
best_practices:
...
# Output to file
node .claude/skills/project-analyzer/analyzer.mjs --output .claude/context/artifacts/project-analysis.json
