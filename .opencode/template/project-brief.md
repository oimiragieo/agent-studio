...
| {{metric_3}} | {{baseline_3}} | {{target_3}} | {{timeframe_3}} |
...
| Role | Count | Skills |
|------|-------|--------|
| {{role_1}} | {{count_1}} | {{skills_1}} |
| {{role_2}} | {{count_2}} | {{skills_2}} |
...
---
*This project brief provides foundation for PRD and architecture documents.*
