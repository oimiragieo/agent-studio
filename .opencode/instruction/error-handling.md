...
CAUSE: File '.opencode/agent/analyst.md' not found
RECOVERY: 
...
### File System Errors
```
ERROR: Cannot write to '.opencode/context/artifacts/prd.md'
...
### Error Codes:
- **OMG_001-099**: Agent-related errors
- **OMG_100-199**: Workflow execution errors
- **OMG_200-299**: Template processing errors
- **OMG_300-399**: File system and I/O errors
- **OMG_400-499**: User input and validation errors
- **OMG_500-599**: System and configuration errors
