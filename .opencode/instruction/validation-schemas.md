# Validation Schemas & Data Models

This document defines the validation schemas and data models used throughout the OpenCode Orchestrator system to ensure consistency and correctness.

## Core Data Models

### WorkflowModel

Defines the structure of workflow definitions:
...
- Workflows: `.opencode/workflow/*.yaml`
- Agents: `.opencode/agent/*.md`
- Templates: `.opencode/template/*.md`
- Context: `.opencode/context/session.json`
...
_This document establishes the validation framework for all OpenCode Orchestrator components. All workflows, agents, and templates must conform to these schemas to ensure system reliability and consistency._
